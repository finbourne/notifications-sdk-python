...
# Python SDK for the FINBOURNE Notifications API
...
This is the python SDK for the FINBOURNE Notifications API, part of the [LUSID by FINBOURNE](https://www.finbourne.com/lusid-technology) platform. To use it you'll need a LUSID account - [sign up for free at lusid.com](https://www.lusid.com/app/signup).
...
```
poetry add lusid-notifications-sdk
```

If using [pip](https://pypi.org/project/pip/)

```
pip install lusid-notifications-sdk
```
