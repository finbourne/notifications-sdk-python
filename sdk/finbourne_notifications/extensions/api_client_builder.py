...
from finbourne_notifications.api_client import ApiClient as AsyncApiClient
...
import finbourne_notifications.extensions.retry as retry
from finbourne_notifications.extensions.socket_keep_alive import keep_alive_socket_options
from finbourne_notifications.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for finbourne_notifications if needed
