...
from lusid_notifications.api_client import ApiClient as AsyncApiClient
...
import lusid_notifications.extensions.retry as retry
from lusid_notifications.extensions.socket_keep_alive import keep_alive_socket_options
from lusid_notifications.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for lusid_notifications if needed
